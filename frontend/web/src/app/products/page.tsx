...
import { Filter, SlidersHorizontal, Heart, TrendingDown } from 'lucide-react';
...
export default function ProductsPage() {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: () => api.product.getAll({ page, limit: 24, ...filters }),
  });
          ...
          <aside className="lg:col-span-1">
            <div className="bg-white rounded-lg p-6 shadow-sm sticky top-20">
              <div className="flex items-center justify-between mb-6">
                ...
                <button
                  onClick={() => setFilters({ category: '', brand: '', minPrice: '', maxPrice: '', sort: 'popular' })}
